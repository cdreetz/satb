        ...
        <CardContent>
          <ul className='space-y-4'>
            <li className='border-b pb-4'>
              <Link href="/author/blog-post" className='block hover:bg-gray-100 p-2 rounded'>
                <h3 className='text-lg font-semibold'>Example blog post</h3>
                <p className='text-sm text-gray-500'>2024-08-05</p>
              </Link>
            </li>
            <li className='border-b pb-4'>
              <Link href="/author/welcome-to-satb" className='block hover:bg-gray-100 p-2 rounded'>
                <h3 className='text-lg font-semibold'>Welcome to SATB</h3>
                <p className='text-sm text-gray-500'>2024-08-05</p>
              </Link>
            </li>
          </ul>
