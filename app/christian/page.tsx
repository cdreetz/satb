        ...
        <CardContent>
          <ul className='space-y-4'>
            <li className='border-b pb-4'>
              <Link href="/christian/why-nextjs" className='block hover:bg-gray-100 p-2 rounded'>
                <h3 className='text-lg font-semibold'>Why I Use Next.JS</h3>
